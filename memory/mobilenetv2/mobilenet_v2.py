...
from cost_profiler import count_activation_size
...
#     net = InvertedResidual(input_channel, output_channel, stride = s, expand_ratio=t, norm_layer=nn.BatchNorm2d, quantized = True)
#     input_channel = output_channel
#     print(net)
#     input = torch.randn(input_resolution[idx])
#     print(net(input))
